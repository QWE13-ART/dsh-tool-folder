 ...
 *
 * VENDOR SOURCE (2026-09-02): dsh-skill-folder/lib/bm25.js vendors this file
 * verbatim (comments may diverge per repo). Modify here, then mirror the code
 * change into the skill repo. Sync gate: `node E:\DSH-Data\scripts\check-vendor-sync.mjs`.
 * semantic.js is intentionally DIVERGED (tool has incremental cache/sha1) and
