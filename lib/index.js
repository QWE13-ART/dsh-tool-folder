...
export function apply(ctx, config) {
  ...
  // serverOf is the module-level function defined above (mcp__server__tool →
  // "mcp__server", openhands_* → "openhands", plain native tools → "native").
  // P3-1 (2026-09-02): the previous apply-local copy (split("__").slice(0,2))
  // let plain tools be their own "server", diverging from catalogText grouping
  // and making sibling closure useless for native/openhands families. One
  // definition, one口径.
